...
function printImages($userID){
	...
	foreach ($resultd['data']as $items) {
		$image_url = $items['images']['low_resolution']['url'];//goinng to go through all of my results and give myself back the URL of those pictures because we want to save it  in the PHP Server.
